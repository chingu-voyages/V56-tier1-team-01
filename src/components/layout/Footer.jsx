...
export default function Footer() {
    return (
        <div className="bg-white relative left-0 bottom-0 w-full flex flex-col items-center text-slate-800 md:flex-row gap-0 md:gap-20 justify-center pb-0 md:pb-3 pt-0 md:pt-3 border-t">
